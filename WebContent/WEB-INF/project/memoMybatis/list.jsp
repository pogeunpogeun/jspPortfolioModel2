...
<c:forEach var = "listDto" items = "${list }">
	<tr>
		<td align="center">${listDto.memoNo }</td>
		<td><a href="#" onClick="move('memoMybatis_view.do','${listDto.memoNo }');">${listDto.subject }</a></td>
		<td align="center">${listDto.writer }</td>
		<td align="center">${listDto.regiDate }</td>
	</tr>		
</c:forEach>
</table>
